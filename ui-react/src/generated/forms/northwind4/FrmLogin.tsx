        ...
        <div style={{ position: 'relative', height: 252, backgroundColor: 'transparent' }}>
          ...
          {getControlState('cmdLogin').visible !== false && (
            <button 
              ...
              onClick={() => fireEvent('cmdLogin', 'on-click')}
            >
              {(() => {
          ...
          {/* AutoLogin_chk */}
          {getControlState('AutoLogin_chk').visible !== false && (
            <input
              type="checkbox"
              style={{
                position: 'absolute',
              ...
              disabled={!allowEdits || getControlState('AutoLogin_chk').enabled === false}
              onChange={(e) => {
                onFieldChange('AutoLogin_chk', e.target.checked);
                fireEvent('AutoLogin_chk', 'after-update');
              }}
              checked={!!f('AutoLogin_chk')}
            />
          )}
