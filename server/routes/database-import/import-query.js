...
module.exports = function(router, pool, secrets) {
  ...
  router.post('/import-query', async (req, res) => {
    ...
    try {
      ...
      if (isDep) {
        ...
        logError(pool, 'POST /api/database-import/import-query', 'Failed to import query', err, {
  ...
  /**
   * POST /api/database-import/tag-state-controls
  ...
  router.post('/create-function-stubs', async (req, res) => {
    try {
      ...
      logError(pool, 'POST /api/database-import/create-function-stubs', 'Failed to create function stubs', err);
  ...
  router.post('/tag-state-controls', async (req, res) => {
    try {
      ...
      logError(pool, 'POST /api/database-import/tag-state-controls', 'Failed to tag state controls', err);
