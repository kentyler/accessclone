/**
 * CloneTemplate - Electron Main Process
 *
...
`;
    ...
    const systemPrompt = `You are an assistant for CloneTemplate, helping users set up and develop their application on Windows.
${projectContext}
${logSummary}

${installSkill || 'Help the user install CloneTemplate.'}
